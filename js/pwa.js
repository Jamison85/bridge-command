...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-18";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-18", { updateViaCache: "none" });
