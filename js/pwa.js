...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-17";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-17", { updateViaCache: "none" });
