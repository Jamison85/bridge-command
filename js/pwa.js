...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-1";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-1", { updateViaCache: "none" });
