...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-8";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-8", { updateViaCache: "none" });
