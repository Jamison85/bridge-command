...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-15";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-15", { updateViaCache: "none" });
