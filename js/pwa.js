...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-25";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-25", { updateViaCache: "none" });
