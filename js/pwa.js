...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-11";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-11", { updateViaCache: "none" });
