...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-28";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-28", { updateViaCache: "none" });
