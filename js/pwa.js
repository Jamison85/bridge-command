...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-26";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-26", { updateViaCache: "none" });
