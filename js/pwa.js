...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-2";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-2", { updateViaCache: "none" });
