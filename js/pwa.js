...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-3";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-3", { updateViaCache: "none" });
