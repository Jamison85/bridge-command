...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-24";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-24", { updateViaCache: "none" });
