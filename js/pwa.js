...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-27";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-27", { updateViaCache: "none" });
