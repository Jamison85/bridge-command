...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-16";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-16", { updateViaCache: "none" });
