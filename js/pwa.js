...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-21";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-21", { updateViaCache: "none" });
