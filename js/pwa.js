...
const reloadGuardKey = "storePilot.pwaReloaded.command-center-7";
...
async function registerServiceWorker() {
  try {
    const registration = await navigator.serviceWorker.register("./sw.js?v=command-center-7", { updateViaCache: "none" });
